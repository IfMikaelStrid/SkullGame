...
//    final int GROUND = 455;
    ...
    public static Rectangle tempfootleft = new Rectangle(0,0,0,0);
    public static Rectangle tempfootright = new Rectangle(0,0,0,0);
    ...
    public void update() {
        ...
        rect.setRect(centerX - 45, centerY - 65	, 25, 20);
        rect2.setRect(rect.getX() - 2, rect.getY() + 20, 22, 30);
        yellowRed.setRect(centerX - 49, centerY - 68, 32, 58);
        
        footleft.setRect(centerX - 46, centerY - 20  , 10, 2);
        footright.setRect(centerX - 35, centerY - 20 , 10, 2);
